...
export const metadata = getArticleById("using-mdx-to-render-blogs-via-server-components");
...
Last updated <time dateTime={metadata.publishedAt}>{metadata.publishedAt}</time>
  ...
  return (
    <article className="my-12">
      <header>
        ...
        <p className="mt-6 mb-12 text-gray-600">
